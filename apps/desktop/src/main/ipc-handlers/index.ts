...
import { registerGitHubCopilotAuthHandlers } from './github-copilot-auth-handlers';
...
export function setupIpcHandlers(
  ...
  // GitHub Copilot Device Flow authentication handlers
  registerGitHubCopilotAuthHandlers();
